...
//             </div>
//             <div>
//               <h1 className="text-xl font-bold text-gray-900">AcademicWrite</h1>
//               <p className="text-xs text-gray-500">AI-Powered Essay Assessment</p>
//             </div>
//           </div>
...
//                 </div>
//                 <div className={`px-3 py-1 rounded-full border text-xs font-medium ${getLevelColor(student.level)}`}>
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">AI-Powered Essay Assessment</p>
            </div>
          </motion.div>
                  ...
                  {showUserMenu && (
                    ...
                    >
                      ...
                      <div className="px-4 py-3 border-b border-gray-700/50">
                        ...
                        <div className={`mt-2 px-3 py-1 rounded-full border text-xs font-medium ${getLevelColor(student.level)}`}>
                          {student.level.charAt(0).toUpperCase() + student.level.slice(1)} Writer
                        </div>
                      </div>
